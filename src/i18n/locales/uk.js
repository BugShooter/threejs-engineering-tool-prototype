(function() {
  ...
  const messages = {
    ...
    actions: {
      ...
      addAndEditLength: 'Додати й налаштувати довжину',
      connect: 'Зʼєднати',
    ...
    dialogs: {
      clearSceneConfirm: 'Очистити сцену? Цю дію можна скасувати.'
    },
    widgets: {
      structure: 'Структура',
      catalog: 'Каталог',
      savedAssemblies: 'Збережені',
      assemblies: 'Збірки',
      parts: 'Деталі',
      library: 'Бібліотека',
      add: 'Додати',
      ...
      propertiesEmpty: 'Виберіть деталь або звʼязок',
      propertiesPorts: 'Порти',
      propertiesLinkedParts: 'Повʼязані деталі',
      portReady: 'Готовий до зʼєднання',
      portPassive: 'Лише цільовий порт',
    ...
    callout: {
      ...
      openLengthEditor: 'Відкрити властивості й сфокусувати поле довжини',
      openProperties: 'Відкрити властивості',
      closeCallout: 'Закрити виноску',
