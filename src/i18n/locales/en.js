(function() {
  ...
  const messages = {
    ...
    actions: {
      ...
      addAndEditLength: 'Add and edit length',
      connect: 'Connect',
      disconnect: 'Disconnect part',
      selectConnectedStructure: 'Select structure',
    ...
    dialogs: {
      clearSceneConfirm: 'Clear the scene? This can be undone.'
    },
    widgets: {
      structure: 'Structure',
      catalog: 'Catalog',
      ...
      propertiesEmpty: 'Select a part or connection',
      propertiesPorts: 'Ports',
      propertiesLinkedParts: 'Linked parts',
      portReady: 'Ready to connect',
      portPassive: 'Target-only port',
      selectStructureCaption: 'Select the connected structure',
      deleteStructureCaption: 'Delete the entire connected structure',
    ...
    callout: {
      ...
      selectConnectedStructure: 'Select the connected structure',
      selectSinglePart: 'Return to a single-part selection',
      deleteSelectedStructure: 'Delete the selected structure',
      ...
      openLengthEditor: 'Open Properties and focus the length field',
      openProperties: 'Open Properties',
      closeCallout: 'Close callout',
